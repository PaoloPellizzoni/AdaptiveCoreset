...
import src.core.css.CSSOblivious;
import java.util.*;

public class CoresetOblivious2
{
    public CoresetOblivious2(double _beta, double _eps, int _wSize, int _k)
    {
        beta = _beta;
        delta = _eps/(1+beta);
        wSize = _wSize;
        ...
        diameter = new CSSOblivious(beta, wSize, 1);
    }
